...
extension Color {
    ...
    static let tabBarBorderr = Color("Tab Bar Border").opacity(0.5)
    static let forecasttCardBackground = Color("Forecast Card Background")
    static let probabilitiText = Color("Probability Text")
}
